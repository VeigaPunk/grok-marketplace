...
| slash (not CLIs) | `/xbgst` (SSoT) `/xbreed-team` (clone) `/xgs` `/xbgst-livepatch` `/xbgst-primeagent` | `~/.grok/commands/*.md` | PATH `xbreed` is a **different** object (Rust ELF 8.16.137). Unshipped: `/xb` `/xbt` `/xbreed`. |
