...
- **Marketplace (`xbgst-stack`):** `install-host.sh` binds the timer to nested stack `livepatch/` by default.
- **This tree / standalone clone:** `./scripts/install-timer.sh` binds the unit here.
