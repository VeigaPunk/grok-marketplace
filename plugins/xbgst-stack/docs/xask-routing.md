...
Quick reference for **sensible model routing**. Hangar **pins** stay in [`model-routing.md`](model-routing.md) — this page does **not** move them. Flag surface: PATH xask / ds4cc `docs/xask-protocol.md`.
