...
| `xask --provider cursor --model-id kimi-k3-max` | named gravy lane (not hangar FIRST) → `cursor-agent -p --output-format text --model kimi-k3-max`; named-not-first | hangar gx-* FIRST; L3 spark; `--service-tier fast` |
