...
That pane **is** a Grok L1: it loads `/xbreed-team` (skill **xbgst**) there and may Pareto / `APPROVED` / ship in that cwd. This pane stays the parent L1 and **does not wait**.
